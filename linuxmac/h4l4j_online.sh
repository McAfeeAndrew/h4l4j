...
LOG_FILE='/var/McAfee/agent/logs/h4l4j.log' # Placing the logs in Agent Log folder make it possible to pull these from ePO using Single System Troublshooting

CUSTOM_PROP='7'  # which custom prop to use for 
